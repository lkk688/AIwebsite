...
export default function Navbar() {
  ...
  return (
    <header className="fixed w-full z-50 flex flex-col transition-all duration-300">
      <PromotionBanner />
      <nav className={`w-full transition-all duration-300 ${scrolled ? 'bg-white shadow-md py-3' : 'bg-gradient-to-r from-blue-900/80 to-blue-800/80 backdrop-blur-md py-4 border-b border-white/10'}`}>
